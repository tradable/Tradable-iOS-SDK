...
@property (nonatomic, readonly) NSDate * __nonnull expirationDate;
...
///
/// \param logoCompleted A closure containing the small broker logo for this account.
- (void)getSmallBrokerLogo:(void (^ __null_unspecified)(UIImage * __nonnull))logoCompleted;

/// Fetches a broker logo on light background and caches it.
///
/// \param logoCompleted A closure containing the broker logo on light background for this account.
- (void)getLightBrokerLogo:(void (^ __null_unspecified)(UIImage * __nonnull))logoCompleted;

/// Fetches a broker logo on dark background and caches it.
///
/// \param logoCompleted A closure containing the broker logo on dark background for this account.
- (void)getDarkBrokerLogo:(void (^ __null_unspecified)(UIImage * __nonnull))logoCompleted;

/// Fetches broker logo in SVG format and caches it.
///
/// \param logoCompleted A closure containing the broker logo in SVG format for this account.
- (void)getSvgBrokerLogo:(void (^ __null_unspecified)(UIImage * __nonnull))logoCompleted;
@end
...
@property (nonatomic, readonly) TradableAccountMetrics * __nonnull metrics;

/// The orders belonging to the account.
@property (nonatomic, readonly) TradableOrders * __nonnull orders;

/// The positions belonging to the account.
@property (nonatomic, readonly) TradablePositions * __nonnull positions;
...
@property (nonatomic, readonly) NSHTTPURLResponse * __nonnull rawHttpResponse;
...
@property (nonatomic) UIImage * __nullable userThumbImg;

/// Picture image of the user.
@property (nonatomic) UIImage * __nullable userPicImg;
...
@property (nonatomic, readonly) TradableAccount * __nonnull account;
